...
# write a test class to test form functionality i.e. post request
class TestCreate(TestBase):
    def test_home_post(self):
        response = self.client.post(url_for('home'), data=dict(name="hawa"))
        test_obj = Register.query.filter_by(name = "hawa").first()
        self.assertEqual(test_obj.name, "hawa")